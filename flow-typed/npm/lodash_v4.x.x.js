...
declare module 'lodash' {
    ...
    declare class Lodash {
        ...
        xorBy<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>, iteratee?: ValueOnlyIteratee<T>): Array<T>;
        xorBy<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>, a3: $ReadOnlyArray<T>, iteratee?: ValueOnlyIteratee<T>): Array<T>;
        xorBy<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>, a3: $ReadOnlyArray<T>, a4: $ReadOnlyArray<T>, iteratee?: ValueOnlyIteratee<T>): Array<T>;
        //Workaround until (...parameter: T, parameter2: U) works
        ...
        xorWith<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>, a3: $ReadOnlyArray<T>, comparator?: Comparator<T>): Array<T>;
        xorWith<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>, a3: $ReadOnlyArray<T>, a4: $ReadOnlyArray<T>, comparator?: Comparator<T>): Array<T>;
        ...
        zip<A, B, C, D, E>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>, a4: $ReadOnlyArray<D>, a5: $ReadOnlyArray<E>): Array<[A, B, C, D, E]>;
        ...
        zipWith<T, A, B>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, iteratee: (A, B) => T): $ReadOnlyArray<T>;

        zipWith<A, B, C>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>): Array<[A, B, C]>;
        zipWith<T, A, B, C>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>, iteratee: (A, B, C) => T): Array<T>;

        zipWith<A, B, C, D>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>, a4: $ReadOnlyArray<D>): Array<[A, B, C, D]>;
        zipWith<T, A, B, C, D>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>, a4: $ReadOnlyArray<D>, iteratee: (A, B, C, D) => T): Array<T>;
        ...
        debounce<F: (...any[]) => any>(func: F, wait?: number, options?: DebounceOptions): F & Cancelable;
        ...
        throttle<F: (...any[]) => any>(func: F, wait?: number, options?: ThrottleOptions): F & Cancelable;
...
declare module 'lodash/fp' {
    ...
    declare class Lodash {
        ...
        intersectionBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>): (a2: Array<T>) => Array<T>;
        intersectionBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>;
        intersectionWith<T>(
            comparator: Comparator<T>
        ): ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>);
        intersectionWith<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>): (a2: $ReadOnlyArray<T>) => Array<T>;
        intersectionWith<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>;
        ...
        sortedIndex<T>(value: T, array: $ReadOnlyArray<T>): number;
        sortedIndexBy<T>(iteratee: ValueOnlyIteratee<T>): ((value: T) => (array: $ReadOnlyArray<T>) => number) & ((value: T, array: Array<T>) => number);
        ...
        sortedLastIndex<T>(value: T, array: $ReadOnlyArray<T>): number;
        sortedLastIndexBy<T>(iteratee: ValueOnlyIteratee<T>): ((value: T) => (array: $ReadOnlyArray<T>) => number) & ((value: T, array: Array<T>) => number);
        sortedLastIndexBy<T>(iteratee: ValueOnlyIteratee<T>, value: T): (array: $ReadOnlyArray<T>) => number;
        sortedLastIndexBy<T>(iteratee: ValueOnlyIteratee<T>, value: T, array: $ReadOnlyArray<T>): number;
        ...
        unionBy<T>(iteratee: ValueOnlyIteratee<T>): ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>);
        unionBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>): (a2: $ReadOnlyArray<T>) => Array<T>;
        unionBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>;
        ...
        symmetricDifference<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>;
        xorBy<T>(iteratee: ValueOnlyIteratee<T>): ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>);
        xorBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>): (a2: $ReadOnlyArray<T>) => Array<T>;
        xorBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>;
        symmetricDifferenceBy<T>(
            iteratee: ValueOnlyIteratee<T>
        ): ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>);
        symmetricDifferenceBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>): (a2: Array<T>) => Array<T>;
        symmetricDifferenceBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>;
        ...
        symmetricDifferenceWith<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>): (a2: $ReadOnlyArray<T>) => Array<T>;
        symmetricDifferenceWith<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>;
        zip<A, B>(a1: $ReadOnlyArray<A>): (a2: $ReadOnlyArray<B>) => Array<[A, B]>;
        zip<A, B>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>): Array<[A, B]>;
        ...
        zipWith<T>(iteratee: Iteratee<T>, a1: NestedArray<T>, a2: NestedArray<T>): Array<T>;
        // Collection
        countBy<T>(iteratee: ValueOnlyIteratee<T>): (collection: $ReadOnlyArray<T> | { [id: any]: T }) => { [string]: number };
        countBy<T>(iteratee: ValueOnlyIteratee<T>, collection: $ReadOnlyArray<T> | { [id: any]: T }): { [string]: number };
        // alias of _.forEach
