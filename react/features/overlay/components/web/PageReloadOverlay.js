...
import AbstractPageReloadOverlay, { abstractMapStateToProps, type Props } from '../AbstractPageReloadOverlay';
    ...
    render() {
        ...
        return (
            <OverlayFrame isLightOverlay={isNetworkFailure}>
                <div className="inlay">
                    <span className="reload_overlay_title">{t(title)}</span>
                    <span className="reload_overlay_text">{t(message, { seconds: timeLeft })}</span>
