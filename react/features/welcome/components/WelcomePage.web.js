...
class WelcomePage extends AbstractWelcomePage {
    ...
    constructor(props) {
         ...
         * @type {HTMLTemplateElement|null}
         */
        this._additionalCardTemplate = document.getElementById('welcome-page-additional-card-template');
         ...
         * @type {HTMLTemplateElement|null}
         */
        this._additionalToolbarContentTemplate = document.getElementById('settings-toolbar-additional-content-template');
    ...
    componentDidMount() {
        ...
        if (this._shouldShowAdditionalToolbarContent()) {
            this._additionalToolbarContentRef.appendChild(this._additionalToolbarContentTemplate.content.cloneNode(true));
        }

        if (this._shouldShowAdditionalCard()) {
            this._additionalCardRef.appendChild(this._additionalCardTemplate.content.cloneNode(true));
        }
    }
            ...
            <div className={`welcome ${showAdditionalContent ? 'with-content' : 'without-content'}`} id="welcome_page">
                ...
                <div className="header">
                    <div className="welcome-page-settings">
                        ...
                        {showAdditionalToolbarContent ? <div className="settings-toolbar-content" ref={this._setAdditionalToolbarContentRef} /> : null}
                    </div>
                    ...
                    <div className="header-container">
                        ...
                        <div id="enter_room">
                            <div className="enter-room-input-container">
                                <form onSubmit={this._onFormSubmit}>
                                    ...
                                    />
                                    <div className={_moderatedRoomServiceUrl ? 'warning-with-link' : 'warning-without-link'}>{this._renderInsecureRoomNameWarning()}</div>
                                </form>
                            </div>
                            <button
                                aria-disabled="false"
                        ...
                        {_moderatedRoomServiceUrl && (
                            <div id="moderated-meetings">
                                <p>{translateToHTML(t, 'welcomepage.moderatedMessage', { url: _moderatedRoomServiceUrl })}</p>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="welcome-cards-container">
                    <div className="welcome-card-row">
                        ...
                        {showAdditionalCard ? <div className="welcome-card welcome-card--dark" ref={this._setAdditionalCardRef} /> : null}
                    </div>

                    {showAdditionalContent ? <div className="welcome-page-content" ref={this._setAdditionalContentRef} /> : null}
                </div>
    ...
    _renderFooter() {
        const { t } = this.props;
        const { MOBILE_DOWNLOAD_LINK_ANDROID, MOBILE_DOWNLOAD_LINK_F_DROID, MOBILE_DOWNLOAD_LINK_IOS } = interfaceConfig;
                ...
                <div className="welcome-footer-centered">
                    <div className="welcome-footer-padded">
                        <div className="welcome-footer-row-block welcome-footer--row-1">
                            ...
                            <a className="welcome-badge" href={MOBILE_DOWNLOAD_LINK_IOS}>
                                <img src="./images/app-store-badge.png" />
                            </a>
                            <a className="welcome-badge" href={MOBILE_DOWNLOAD_LINK_ANDROID}>
                                <img src="./images/google-play-badge.png" />
                            </a>
                            <a className="welcome-badge" href={MOBILE_DOWNLOAD_LINK_F_DROID}>
