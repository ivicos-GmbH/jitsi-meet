...
export function _formatConferenceIDPin(conferenceID: Object) {
    ...
    return `${conferenceIDStr.substring(0, partLen)} ${conferenceIDStr.substring(partLen, 2 * partLen)} ${conferenceIDStr.substring(2 * partLen, conferenceIDStr.length)}`; // eslint-disable-line max-len
}
