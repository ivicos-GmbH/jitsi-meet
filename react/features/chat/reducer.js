...
import { ADD_MESSAGE, CLEAR_MESSAGES, CLOSE_CHAT, OPEN_CHAT, SET_PRIVATE_MESSAGE_RECIPIENT } from './actionTypes';
...
ReducerRegistry.register('features/chat', (state = DEFAULT_STATE, action) => {
    switch (action.type) {
        case ADD_MESSAGE: {
            ...
            const messages = navigator.product === 'ReactNative' ? [newMessage, ...state.messages] : [...state.messages, newMessage];
