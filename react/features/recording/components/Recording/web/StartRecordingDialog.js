...
import AbstractStartRecordingDialog, { mapStateToProps } from '../AbstractStartRecordingDialog';
...
class StartRecordingDialog extends AbstractStartRecordingDialog {
     ...
     */
    render() {
        const { isTokenValid, isValidating, selectedRecordingService, sharingEnabled, spaceLeft, userName } = this.state;
        ...
        // when there is token
        const isOkDisabled = _fileRecordingsServiceEnabled ? isValidating : _isDropboxEnabled ? !isTokenValid : false;

        return (
            <Dialog okDisabled={isOkDisabled} okKey="dialog.startRecording" onSubmit={this._onSubmit} titleKey="dialog.startRecording" width="small">
