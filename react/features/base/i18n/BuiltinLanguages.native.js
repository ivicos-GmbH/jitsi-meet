...
const _LANGUAGES = {
    ...
    // Mongolian
    mn: { languages: require('../../../../lang/languages-mn'), main: require('../../../../lang/main-mn') }
};
...
for (const name in _LANGUAGES) {
    ...
    i18next.addResourceBundle(name, 'languages', languages, /* deep */ true, /* overwrite */ true);
    i18next.addResourceBundle(name, 'main', main, /* deep */ true, /* overwrite */ true);
}
