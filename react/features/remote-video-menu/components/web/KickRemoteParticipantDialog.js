...
class KickRemoteParticipantDialog extends AbstractKickRemoteParticipantDialog {
    ...
    render() {
        return (
            <Dialog okKey="dialog.kickParticipantButton" onSubmit={this._onSubmit} titleKey="dialog.kickParticipantTitle" width="small">
                <div>{this.props.t('dialog.kickParticipantDialog')}</div>
            </Dialog>
        );
    }
