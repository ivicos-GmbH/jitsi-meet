...
import AbstractMuteRemoteParticipantDialog, { type Props as AbstractProps } from './AbstractMuteRemoteParticipantDialog';
...
export default class AbstractMuteEveryoneDialog<P: Props> extends AbstractMuteRemoteParticipantDialog<P> {
    ...
    render() {
        ...
        return (
            <Dialog okKey="dialog.muteParticipantButton" onSubmit={this._onSubmit} titleString={title} width="small">
                <div>{content}</div>
            </Dialog>
        );
    }
