...
export default {
    ...
    async _mutePresenterVideo(mute) {
        ...
        if (!this.localPresenterVideo && !mute) {
            ...
            // Replace the desktop track on the peer connection.
            try {
    ...
    _setupListeners() {
        ...
        room.on(JitsiConferenceEvents.STARTED_MUTED, () => {
            ...
            for (const track of localTracks) {
                // Always add the track on mobile Safari because of a known issue where audio play-out doesn't happen
        ...
        APP.UI.addListener(
            ...
            cameraDeviceId => {
                ...
                // If both screen-share and video are in progress, restart the
                ...
                if (this.isSharingScreen && !videoWasMuted) {
                    ...
                    // If screen-share is in progress but video is muted, update the default device
        ...
        APP.UI.addListener(
            ...
            micDeviceId => {
                ...
                createLocalTracksF({
                    ...
                    .then(async stream => {
                        // In case screen sharing audio is also shared we mix it with new input stream.
                        // The old _mixerEffect will be cleaned up when the existing track is replaced.
                        if (this._mixerEffect) {
                            this._mixerEffect = new AudioMixerEffect(this._desktopAudioStream);
    ...
    _updateVideoDeviceId() {
        ...
        // If screen-share is in progress, get the device id from the presenter track.
        if (this.localPresenterVideo) {
            APP.store.dispatch(updateSettings({
